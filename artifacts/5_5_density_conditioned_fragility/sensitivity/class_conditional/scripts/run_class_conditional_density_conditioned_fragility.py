...
def process_seed_block2(
    *,
    ...
    for group in feature_groups:
        ...
        for k_density in k_values:
            density_scores = compute_density_scores(X_train_scaled, X_test_scaled, k_density=k_density)
        ...
        for k_density in k_values:
            ...
            trial_rows = results_by_k[k_density]["trial_rows"]
            class_conditional_composition_rows = results_by_k[k_density]["class_conditional_composition_rows"]
            class_conditional_trial_rows = results_by_k[k_density]["class_conditional_trial_rows"]
