#!/usr/bin/env python3
"""
Build single-view LR manuscript figures for RQ2-3.

Outputs one PDF per evaluation setting:
- RQ2-3_prediction_level_instability_lr_wild_u.pdf
- prediction_flip_rate_masking_wild_b_lr.pdf
- RQ2-3_prediction_level_instability_lr_unpacked_b.pdf
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build single-view LR manuscript figures for RQ2-3.")
...
def main() -> None:
    ...
    for setting in SETTINGS:
        plot_single_view(
            rows,
            args.output_dir / f"RQ2-3_prediction_level_instability_lr_{SETTING_TO_SLUG[setting]}.pdf",
            setting,
        )
    print(f"Saved LR manuscript figures to {args.output_dir}")
