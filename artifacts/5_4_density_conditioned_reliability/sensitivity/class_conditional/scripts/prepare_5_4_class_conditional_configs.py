#!/usr/bin/env python3
"""Generate derived configs for the D3 (density-conditioned reliability, Section 5.4)
...
(which generated both the D3 and D4 jobs in one file) so that D3 assets live under
...
Usage (from anywhere, no PYTHONPATH needed):
    python3 prepare_5_4_class_conditional_configs.py
"""
...
CLASS_CONDITIONAL_ROOT = HERE.parents[1]          # .../5_4_density_conditioned_reliability/sensitivity/class_conditional
SECTION_ROOT = HERE.parents[3]                    # .../5_4_density_conditioned_reliability
...
JOBS = [
    {
        "name": "d3_lr_controlled_main",
        "base_config": SECTION_ROOT / "configs/LR/density_reliability_controlled_main.json",
        "runner": RUNNER_DIR / "run_class_conditional_density_stratified_reliability.py",
        "output_dir": CLASS_CONDITIONAL_ROOT / "results/LR/density_reliability_controlled_main",
        "config_updates": {
            "save_density_rows": True,
    ...
    {
        "name": "d3_lightgbm_controlled_main",
        "base_config": SECTION_ROOT / "configs/LightGBM/density_reliability_controlled_main_lightgbm.json",
        "runner": RUNNER_DIR / "run_class_conditional_density_stratified_reliability.py",
        "output_dir": CLASS_CONDITIONAL_ROOT / "results/LightGBM/density_reliability_controlled_main_lightgbm",
        "config_updates": {
            "k_density_values": [10],
            "save_density_rows": True,
            "save_class_conditional_rows": True,
    ...
    {
        "name": "d3_rf_controlled_main",
        "base_config": SECTION_ROOT / "configs/RF/density_reliability_controlled_main_random_forest.json",
        "runner": RUNNER_DIR / "run_class_conditional_density_stratified_reliability_with_rf.py",
